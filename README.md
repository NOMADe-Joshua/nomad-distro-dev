...
2. Add local plugins
   ...
   [nomad-plugin-template](https://github.com/NOMADe-Joshua/nomad-plugin-template).
   ...
   git submodule add https://github.com/NOMADe-Joshua/nomad-measurements.git packages/nomad-measurements
   ```
...
3. Modify `pyproject.toml`
 ...
 >
 > ```bash
 > uv add https://github.com/NOMADe-Joshua/nomad-measurements.git --branch <specific-branch-name>
 > ```
 > This command will not include the plugin in the `packages/` folder, and hence this plugin
 > will not be editable. 

A complete list of plugins maintained by NOMADe-Joshua can by found in the [overview page](https://github.com/NOMADe-Joshua) of the NOMADe-Joshua organisation.
...
1. Add the upstream Remote
   ...
   ```bash
   git remote add upstream https://github.com/NOMADe-Joshua/nomad-distro-dev.git
   ```
...
=======
![docker image](https://github.com/NOMADe-Joshua/nomad-distro-dev/actions/workflows/docker-publish.yml/badge.svg)


# NOMADe-Joshua's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of NOMADe-Joshua.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/NOMADe-Joshua/nomad-distro-dev.git
    cd nomad-distro-dev
    ```
    ...
    ```sh
    curl-L -o nomad-distro-dev.zip "https://github.com/NOMADe-Joshua/nomad-distro-dev/archive/main.zip"
    unzip nomad-distro-dev.zip
    cd nomad-distro-dev
    ```
...
your `docker-compose.yaml` with `ghcr.io/nomade-joshua/nomad-distro-dev:main` for the services
...
```sh
docker pull ghcr.io/nomade-joshua/nomad-distro-dev/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/NOMADe-Joshua/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/NOMADe-Joshua/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/NOMADe-Joshua/nomad-distro-dev/manifests/main": unauthorized`
